...
func init() {
	...
	message.SetString(language.German, MsgAboutDescription, "Ein Tool zur Erstellung von Kopfschmerzkalendern.")
	message.SetString(language.German, MsgAuthor, "Autor: %s")
